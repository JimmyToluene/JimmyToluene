...
**Graduate Research Assistant @ [Bio-Imaging & Informatics Lab](https://sites.bu.edu/bil/)**, BU Chobanian & Avedisian School of Medicine

`Python` `PyTorch` `MONAI` `FreeSurfer` `3D CNNs` `3D-UNet` `Amyloid PET` `NIfTI`
